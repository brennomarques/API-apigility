...
namespace DoctrineORMModule\Proxy\__CG__\Login\V1\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Endereco extends \Login\V1\Entity\Endereco implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Login\\V1\\Entity\\Endereco' . "\0" . 'id', '' . "\0" . 'Login\\V1\\Entity\\Endereco' . "\0" . 'rua', '' . "\0" . 'Login\\V1\\Entity\\Endereco' . "\0" . 'cidade', '' . "\0" . 'Login\\V1\\Entity\\Endereco' . "\0" . 'estado', '' . "\0" . 'Login\\V1\\Entity\\Endereco' . "\0" . 'numero', '' . "\0" . 'Login\\V1\\Entity\\Endereco' . "\0" . 'bairro', '' . "\0" . 'Login\\V1\\Entity\\Endereco' . "\0" . 'complemento'];
        }
